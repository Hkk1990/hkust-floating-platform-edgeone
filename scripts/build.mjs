...
const extraHead = '<link rel="stylesheet" href="./mobility-control.css?v=20260810-15"/>';
const extraBody = '<script src="./mobility-control.js?v=20260810-15" defer></script>';
...
for (const htmlName of ["index.html", "404.html"]) {
  ...
  const html = readFileSync(htmlPath, "utf8")
    ...
    .replaceAll("platform-float-unit.webp", "platform-float-unit-clean-v3.webp")
